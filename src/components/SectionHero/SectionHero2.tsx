...
const data = [
  {
    ...
    heading: 'Modern Appliances <br /> for your Home',
    subHeading: 'Upgrade your living space 🔥',
    btnText: 'Explore shop now',
    btnHref: '/collections/home-appliances',
  },
  {
    id: 2,
    imageUrl: heroImage2.src,
    heading: 'Smart Electronics <br /> & Gadgets',
    subHeading: 'Stay connected with the best tech 💻',
    btnText: 'Shop Electronics',
    btnHref: '/collections/electric-items',
  },
  {
    id: 3,
    imageUrl: heroImage3.src,
    heading: 'Premium Quality <br /> Office Products',
    subHeading: 'Organize your workspace elegantly ✨',
    btnText: 'Discover Office',
    btnHref: '/collections/office-products',
  },
]
